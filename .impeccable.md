# Closed AI Design System

## Design Context

### Users

The first dashboard is primarily for HR admins and recruiters. They use Closed AI as an internal operating surface for hiring, onboarding, employee support, workflows, documents, and insights.

Candidates and employees may interact with Closed AI through chat, voice, WhatsApp, email, embedded agent flows, portals, or assisted workflows, but the dashboard should not be designed as a general consumer-facing app. The operational control surface belongs to HR teams first.

### Brand Personality

Closed AI should feel calm, intelligent, and trustworthy.

The product should feel premium, but not flashy. Trust matters more than spectacle. The interface should communicate that Closed AI is capable, secure, accurate, and composed enough to handle sensitive HR workflows.

Avoid overly playful, loud, futuristic, or gimmicky AI visuals. Present AI as a capable assistant that accelerates HR work while keeping humans in control, not as magic.

### Aesthetic Direction

Use a light-first interface, with dark mode considered later. Prefer a refined light mode over a dramatic dark AI-console aesthetic.

The first version should feel like a polished SaaS dashboard with selective premium AI-product polish. It should not feel like a marketing landing page, and it should not become an overly dense command center. The target feeling is a clean HR operating system: organized, confident, workflow-driven, and quietly intelligent.

Prioritize clarity, document readability, dense-but-calm workflows, accessibility, and enterprise comfort. HR teams will spend time reading candidate details, documents, summaries, ticket histories, timelines, and structured data, so the UI should be easy to scan for long sessions.

Use premium AI touches where they help: agent status, confidence indicators, summaries, suggested actions, automation timelines, conversation intelligence, document extraction, workflow recommendations, human review states, and audit-friendly logs.

### Design Principles

- Design for HR admins and recruiters first: fast scanning, clear navigation, strong hierarchy, practical workflows, and clear role-aware operations.
- Make AI accountable: show source context, confidence where useful, suggested next actions, editable drafts, escalation paths, and human handoff states.
- Keep the interface calm and enterprise-ready: avoid decorative AI gimmicks, excessive gradients, unnecessary animation, and abstract visuals.
- Support sensitive work: prioritize privacy, consent, role-based access, role isolation, audit logs, secure document handling, and compliance-friendly flows.
- Prefer dense-but-readable product UI over landing-page composition: summarize tables, provide filters, make documents and histories readable, and keep repeated workflows efficient.

## Design System Inspired by ElevenLabs

**Active implementation directive:** This ElevenLabs-inspired system is the
visual source of truth for Closed AI dashboard work. Do not substitute Stitch's
generated "Arbor & Ink" direction, teal/sage accent palettes, Manrope/Afacad
headlines, or tonal-material dashboard styling. Use the near-white canvas,
warm stone surfaces, black pill CTAs, Waldenburg-style light display headings,
Inter UI text, and multi-layer whisper shadows described below.
